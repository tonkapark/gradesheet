module Gradesheet
  class Setup
    ...
    def load_sample_data
      ...
      [Assignment, AssignmentEvaluation, Course, AssignmentCategory, SupportingSkill, SupportingSkillCategory, ScaleRange, GradingScale, Term, SchoolYear, Person, PersonRole, Site, Building, Room, School, Enrollment, CourseTerm, User].each(&:delete_all)
      ...
      10.times do
        ...
        1.times do
          ...
          course_offering = CourseTerm.create!( :code => "#{course.code}-001", :course_id => course.id, :term_id => first_semester.id, :teacher_id => teacher.id, :seats => Populator.value_in_range(1..room.seats), :room_id => room.id) 
          2.times do
          ...
          course_offering2 = CourseTerm.create!( :code => "#{course.code}-001", :course_id => course.id, :term_id => second_semester.id, :teacher_id => teacher.id, :seats => Populator.value_in_range(1..room.seats), :room_id => room.id)   
          2.times do
