...
5. Run <tt>rake gradesheet:setup</tt> to create admin user and site defaults.
5. Run <tt>rake db:fixtures:load</tt> to load the text/fixtures data. (safe only for dev/test)
